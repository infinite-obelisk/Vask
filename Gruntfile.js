  ...
  grunt.initConfig({
    ...
    exec: {
      reactify: {
        ...
        command: "browserify -t reactify uccviews/jsx/lectureView.js -o client/build/js/lectureView.js && browserify -t reactify uccviews/jsx/template.js -o client/build/js/template.js && browserify -t reactify uccviews/jsx/dynamicSearch.jsx -o client/build/js/dynamicSearch.js && browserify -t reactify uccviews/jsx/lecturesListView.jsx -o client/build/js/lecturesListView.js && browserify -t reactify uccviews/jsx/signinSignup.js -o client/build/js/signinSignup.js"
      },
      server: {
